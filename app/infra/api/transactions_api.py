...
status_translator: Dict[int, Any] = {
    ...
    400: {"status_code": status.HTTP_400_BAD_REQUEST, "msg": "Not enough funds in the wallet"},
...
@transactions_api.post("/wallets/{address}/deposit", status_code=status.HTTP_201_CREATED)
def deposit(
        api_key: str,
        address: str,
        amount: float,
...
@transactions_api.post("/wallets/{address}/withdraw", status_code=status.HTTP_201_CREATED)
def withdraw(
        api_key: str,
        address: str,
        amount: float,
